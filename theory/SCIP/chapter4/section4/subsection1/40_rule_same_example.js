...
process_query(`assert(address(list("Bitdiddle", "Ben"),
                              list("Slumerville", list("Ridge", "Road"), 10)))`, "silent");
process_query(`assert(job(list("Bitdiddle", "Ben"), 
                          list("computer", "wizard")))`, "silent");
process_query(`assert(salary(list("Bitdiddle", "Ben"), 122000))`, "silent");
process_query('assert(address(list("Hacker", "Alyssa", "P"), list("Cambridge", list("Mass", "Ave"), 78)))', "silent");
process_query('assert(job(list("Hacker", "Alyssa", "P"), list("computer", "programmer")))', "silent");
process_query('assert(salary(list("Hacker", "Alyssa", "P"), 81000))', "silent");
process_query('assert(supervisor(list("Hacker", "Alyssa", "P"), list("Bitdiddle", "Ben")))', "silent");

process_query('assert(address(list("Fect", "Cy", "D"), list("Cambridge", list("Ames", "Street"), 3)))', "silent");
process_query('assert(job(list("Fect", "Cy", "D"), list("computer", "programmer")))', "silent");
process_query('assert(salary(list("Fect", "Cy", "D"), 70000))', "silent");
process_query('assert(supervisor(list("Fect", "Cy", "D"), list("Bitdiddle", "Ben")))', "silent");

process_query('assert(address(list("Tweakit", "Lem", "E"), list("Boston", list("Bay", "State", "Road"), 22)))', "silent");
process_query('assert(job(list("Tweakit", "Lem", "E"), list("computer", "technician")))', "silent");
process_query('assert(salary(list("Tweakit", "Lem", "E"), 51000))', "silent");
process_query('assert(supervisor(list("Tweakit", "Lem", "E"), list("Bitdiddle", "Ben")))', "silent");
process_query('assert(address(list("Reasoner", "Louis"), list("Slumerville", list("Pine", "Tree", "Road"), 80)))', "silent");
process_query('assert(job(list("Reasoner", "Louis"), list("computer", "programmer", "trainee")))', "silent");
process_query('assert(salary(list("Reasoner", "Louis"), 62000))', "silent");
...
process_query('assert(address(list("Warbucks", "Oliver"), list("Swellesley", list("Top", "Heap", "Road"))))', "silent");
process_query('assert(job(list("Warbucks", "Oliver"), list("administration", "big", "wheel")))', "silent");
process_query('assert(salary(list("Warbucks", "Oliver"), 314159))', "silent");
process_query('assert(address(list("Scrooge", "Eben"), list("Weston", list("Shady", "Lane"), 10)))', "silent");
process_query('assert(job(list("Scrooge", "Eben"), list("accounting", "chief", "accountant")))', "silent");
process_query('assert(salary(list("Scrooge", "Eben"), 141421))', "silent");
process_query('assert(supervisor(list("Scrooge", "Eben"), list("Warbucks", "Oliver")))', "silent");

process_query('assert(address(list("Cratchit", "Robert"), list("Allston", list("N", "Harvard", "Street"), 16)))', "silent");
process_query('assert(job(list("Cratchit", "Robert"), list("accounting", "scrivener")))', "silent");
process_query('assert(salary(list("Cratchit", "Robert"), 26100))', "silent");
process_query('assert(supervisor(list("Cratchit", "Robert"), list("Scrooge", "Eben")))', "silent");
process_query('assert(address(list("Aull", "DeWitt"), list("Slumerville", list("Onion", "Square"), 5)))', "silent");
process_query('assert(job(list("Aull", "DeWitt"), list("administration", "assistant")))', "silent");
process_query('assert(salary(list("Aull", "DeWitt"), 42195))', "silent");
...
process_query('assert(can_do_job(list("administration", "assistant"), list("administration", "big", "wheel")))', "silent");
process_query('assert(rule(same(x, x)))', "silent");
first_answer('same(list("Reasoner", first_name), list(sur_name, "Louis"))');
